...
Implementações do padrão *Fluent Builder* para `Aluno` e `Administrador`, permitindo o encadeamento de métodos (`return this;`).
...
A classe `UsuariosService` atua como o *Director* do Builder padrão, orquestrando a criação no Firebase e montando as entidades utilizando os Builders concretos correspondentes. Possui também tratamento de exceções para garantir a consistência dos dados através do *Rollback*.
...
3. **GEEKSFORGEEKS**. *Builder, Fluent Builder and Faceted Builder Method Design Pattern in Java*. GeeksforGeeks, 2023. Disponível em: <https://www.geeksforgeeks.org/system-design/builder-fluent-builder-and-faceted-builder-method-design-pattern-in-java>/. Acesso em: 21/05/2026.
4. **SIMUNOVIC, D**. *Fluent Builder Design Pattern. Hashnode, 2023*. Disponível em: <https://dsimunovic.hashnode.dev/fluent-builder-design-pattern>. Acesso em: 21/05/2026.
5. **SHANTO, M**. *Mastering the Fluent Builder Pattern in C#*: From Basics to Advanced Scenarios. Medium, 2024. Disponível em: <https://medium.com/@shanto462/mastering-the-fluent-builder-pattern-in-c-from-basics-to-advanced-scenarios-b1b702583299>. Acesso em: 21/05/2026.
---
#  Histórico de versão
