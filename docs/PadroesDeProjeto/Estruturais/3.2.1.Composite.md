...
![Diagrama UML - Composite BlockManager](../../assets/imagens/estruturais/BlockManager.png)
...
Para aferir a pertinência e a qualidade da implementação, segue a gravação da execução do código rodando via terminal no ambiente de desenvolvimento: [Clique aqui para assistir ao vídeo da execução do BlockManager](https://youtu.be/vYR2FNTvt2I)
